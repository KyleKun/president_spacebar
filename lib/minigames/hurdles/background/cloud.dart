...
class Cloud extends SpriteComponent with ParentIsA<CloudManager>, HasGameReference<HurdlesGame> {
  Cloud({required Vector2 position})
    : cloudGap = random.fromRange(minCloudGap, maxCloudGap),
  ...
  Future<void> onLoad() async {
    sprite = Sprite(game.spriteImage, srcPosition: Vector2(166.0, 2.0), srcSize: initialSize);
  }
  ...
  void onGameResize(Vector2 size) {
    ...
    y =
        ((absolutePosition.y / 2 - (maxSkyLevel - minSkyLevel)) + random.fromRange(minSkyLevel, maxSkyLevel)) -
