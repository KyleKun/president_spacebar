...
class ObstacleTypeSettings {
  ...
  Sprite sprite(Image spriteImage) {
    return switch (type) {
      ObstacleType.cactusSmall => Sprite(spriteImage, srcPosition: Vector2(446.0, 2.0), srcSize: size),
      ObstacleType.cactusLarge => Sprite(spriteImage, srcPosition: Vector2(652.0, 2.0), srcSize: size),
    };
  }
}
